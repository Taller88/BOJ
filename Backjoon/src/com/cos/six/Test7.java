...
public class Test7 {
	    ...
	    public static int solution(int K, int[] numbers, String[] UpDown) {
	        int left = 1;
	        int right = K;
	    ...
	    public static void main(String[] args) {
	        ...
	        int ret1 = solution(K1, numbers1, UpDown1);
	        ...
	        int ret2 = solution(K2, numbers2, UpDown2);
	        ...
	        int ret3 = solution(K3, numbers3, UpDown3);
