...
public class Test9 {
		...
		static Integer func_a(ArrayList<Integer> stack) {
	        Integer item = stack.remove(stack.size() - 1);
	        return item;
	    }
	    
	    static void func_b(ArrayList<Integer> stack1, ArrayList<Integer> stack2) {
	        while(!func_c(stack1)) {
	    ...
	    static boolean func_c(ArrayList<Integer> stack) {
	        return (stack.size() == 0);
	    }
	    
	    public static int solution(ArrayList<Integer> stack1, ArrayList<Integer> stack2) {
	        if(func_c(stack2)) {
