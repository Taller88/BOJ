...
public class Test7 {
    ...
    public static int[] solution(int monsterAttackPoint, int warriorAttackPoint, int healingPoint) {
    ...
    public static void main(String[] args) {
        ...
        int healingPoint = 30;
        int[] ret = solution(monsterAttackPoint, warriorAttackPoint, healingPoint);
