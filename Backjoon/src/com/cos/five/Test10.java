...
public class Test10 {
    ...
    static  class PartTimeJob extends Job {
    ...
    static class SalesJob extends Job {
    ...
    public static int solution(int[][] partTimeJobs, int[][] salesJobs) {
        int answer = 0;
    ...
    public static void main(String[] args) {
        ...
        int ret = solution(partTimeJobs, salesJobs);
